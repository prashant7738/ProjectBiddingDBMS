...
export const AppProvider = ({ children }) => {
    ...
    const [auctionCache, setAuctionCache] = useState({ active: [], ended: [] });
    const updateActiveCache = (list) => setAuctionCache((prev) => ({ ...prev, active: list }));
    const updateEndedCache  = (list) => setAuctionCache((prev) => ({ ...prev, ended:  list }));
