...
export default function Register() {
  ...
  return (
    <div className="min-h-[calc(125vh)] flex items-center justify-center px-4 py-10 bg-gradient-to-br from-indigo-50 via-white to-purple-50 relative overflow-hidden font-outfit">
