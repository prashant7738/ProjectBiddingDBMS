                      ...
                      if (now > endTime || !auction.is_active) {
                        return (
                          <Link
                            ...
                            className="flex-1 px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white text-sm font-bold rounded-lg transition-all text-center flex items-center justify-center gap-1"
                          >
