...
// ── Skeleton — mirrors the real card's exact layout ───────────────────────────
export const AuctionCardSkeleton = () => (
    <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100 font-mozilla">
        {/* Image — matches h-64 */}
        <div className="relative h-64 bg-gray-200 animate-pulse">
            {/* Live badge placeholder */}
            <div className="absolute top-4 left-4 h-8 w-16 bg-gray-300 rounded-full" />
            {/* Seller badge placeholder */}
            <div className="absolute bottom-4 left-4 h-7 w-28 bg-gray-300 rounded-full" />
        </div>

        {/* Body — matches p-6 mt-2 */}
        <div className="p-6 mt-2 space-y-4 animate-pulse">
            {/* Category + bid count row */}
            <div className="flex items-center justify-between">
                <div className="h-6 w-20 bg-gray-200 rounded-lg" />
                <div className="h-6 w-16 bg-gray-200 rounded-full" />
            </div>

            {/* Title — matches text-xl line-clamp-2 */}
            <div className="space-y-2">
                <div className="h-5 w-full bg-gray-200 rounded" />
                <div className="h-5 w-3/4 bg-gray-200 rounded" />
            </div>

            {/* Current bid + time left row */}
            <div className="flex items-center justify-between">
            ...
            {/* Button — matches py-3.5 rounded-xl */}
